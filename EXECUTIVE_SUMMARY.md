...
We used [**GroceryDB**](https://github.com/Barabasi-Lab/GroceryDB/tree/main), a dataset of 50,468 US grocery products that carries [FPro scores](https://www.nature.com/articles/s41467-023-37457-1). Unlike [NOVA classification](https://www.sciencedirect.com/science/article/abs/pii/S0924224421004970) which assigns foods to one of four discrete categories, FPro uses a continuous 0-1 scale that measures the degree of food processing by evaluating the processing level of each individual ingredient using the FoodProX model. Here 0 indicates no processing and 1 indicates ultra-processed foods. After filtering to products with complete nutrition data and removing physically impossible values, we trained a Random Forest on **12 log-transformed nutrients** (protein, fat, carbohydrates, sugar, fiber, calcium, iron, sodium, cholesterol, saturated fat, vitamin A, vitamin C) to predict FPro as both a continuous score and a four-class label.
